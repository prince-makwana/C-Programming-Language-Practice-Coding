...
namespace DelegateMulticastDelegatesDemo
{
    class Program
    {
        //Type - defiens a method signature(return type and parameter)
        ...
        static void Main(string[] args)
        {
            ...
            PrintDel log = PrintToConsoleLog;   //Multicast Delegates
            log += PrintToEventLog;
